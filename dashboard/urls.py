...
urlpatterns = [
    ...
    path("htmx/clients/<uuid:client_id>/incidents/create/",views.htmx_incident_create,name="htmx-incident-create"),
    path("htmx/incidents/<int:incident_id>/resolve/",views.htmx_incident_resolve,name="htmx-incident-resolve"),
